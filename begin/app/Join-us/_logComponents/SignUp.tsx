...
const SignUp = () => {
  return (
    <>
      <div className="flex font-poppins items-center justify-center dark:bg-gray-900 min-w-screen mt-4">
        <div className="grid gap-4">
          ...
          >
            <div className="border-[20px] border-transparent rounded-[20px] dark:bg-gray-900 bg-white shadow-lg xl:p-10 2xl:p-10 lg:p-10 md:p-10 sm:p-2 m-2">
              <h1 className="pt-2 pb-4 font-bold text-5xl dark:text-gray-400 text-center cursor-default">
                Sign Up
              </h1>
